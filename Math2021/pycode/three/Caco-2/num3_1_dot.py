...
names = featureArray
res_1 = dataSet.columns[0]
res_2 = dataSet.columns[1]
res_3 = dataSet.columns[2]
res_4 = dataSet.columns[3]
res_5 = dataSet.columns[4]
...
plt.ylabel('Caco-2分类结果', fontdict={'weight': 'normal', 'size':13})
plt.title("Caco-2样本测试集结果点状图")
plt.savefig(r'D:\csv\picture\Caco-2样本测试集结果点状图.png', dpi=300)

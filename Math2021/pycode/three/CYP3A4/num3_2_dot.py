...
plt.ylabel('CYP3A4分类结果', fontdict={'weight': 'normal', 'size':13})
plt.title("CYP3A4样本测试集结果点状图")
plt.savefig(r'D:\csv\picture\CYP3A4样本测试集结果点状图.png', dpi=300)
